...
function Login() {
    ...
    const onSubmit = async(data) =>{
        ...
        .then((res)=>{
            ...
            if(res.data){
                toast.success("You are Now Successfully LoggedIn ");
                ...
                <div className="modal-box">
                    <form onSubmit={handleSubmit(onSubmit)} method="dialog">
                        ...
                        <div className='flex justify-around mt-4'>
                            <button className='bg-pink-500 text-white rounded-md px-3 py-1 hover:bg-pink-700 duration-200'>Log-In</button>
